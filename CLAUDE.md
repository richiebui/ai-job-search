...
### Targeting
- [ ] Cover letter's opening paragraph is tailored to the specific role (not generic) - the CV itself has no profile statement/summary, so this framing lives only in the cover letter
- [ ] Skills and experience bullets are reframed to match the job requirements
- [ ] Key job requirements are addressed (with gaps acknowledged where relevant)
- [ ] Nice-to-have requirements are highlighted where there is a match
- [ ] If the posting explicitly requests references (e.g. "please provide references," "references required"), the CV includes them - never cut references to fit the page target when the posting asked for them
- [ ] The most recent role has 3-5 bullets and every *included* role has at least 3 - these are hard floors, never cut below them to force a page count. If not every role fits at these floors, the least-relevant/oldest role was dropped entirely rather than thinned.

### Consistency
- [ ] CV has no profile statement/summary paragraph - it goes straight from the header into Core Competencies
- [ ] CV follows the standard moderncv/banking format and is exactly 1 page
...
- [ ] **CV is exactly 1 page** - not 2, not 3. If the Professional Experience bullet-count floors (3-5 most recent, 3+ every other included role) don't fit at 1 page with the full role history, a role was dropped to make room, not thinned below the floor
